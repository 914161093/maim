...
export function getProvinces() {
	...
	for (var i = 0; i < AreaJson.length; i++) {
		provinces.push(AreaJson[i].value);
	}

	return provinces;
}
export function getProvincesid() {
	var provincesid = [];

	for (var i = 0; i < AreaJson.length; i++) {
		provincesid.push(AreaJson[i].id);
	}
...
export function getMyCityid(provinceIndex) {
	var citysid = [];
...
// 	var areas = [];
// 	areas = AreaJson[provinceIndex].childs[cityIndex].value;
// 	return areas;
// }
